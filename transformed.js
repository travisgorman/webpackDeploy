	...
	const MyComponentClass = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(FirstClass, null),
	      React.createElement(
	        'h1',
	        null,
	        'It Works! I\'m from the index.js file!'
	      )
	    );
	  }
	});

	ReactDOM.render(React.createElement(MyComponentClass, null), document.getElementById('page'));
